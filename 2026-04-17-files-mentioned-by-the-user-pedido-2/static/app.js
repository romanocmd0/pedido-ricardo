...
const elements = {
  ...
  caminhaoTransferenciaQty: document.querySelector("#caminhao-transferencia-qty"),
  ...
  unitCaminhaoTransferencia: document.querySelector("#unit-caminhao-transferencia"),
...
function resetForm() {
  ...
  elements.caminhaoTransferenciaQty.value = 0;
  ...
  elements.unitCaminhaoTransferencia.value = 0;
